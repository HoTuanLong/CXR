...
class complete_model(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        scheduler = torch.optim.lr_scheduler.OneCycleLR(optimizer, max_lr=self.hparams.learning_rate,
                                                        ...
                                                        total_steps=(int(100000 / 32) + 1) * self.hparams.expected_num_epochs + 1,
                                                        epochs=None,
...
def main():
    ...
    wandb.login()
    wandb.init(project="CXR-Patient-ReID-phase1", entity="longht", name='PadChest')
    ...
    # model_dict = '/home/ubuntu/long.ht/cxr-patient-reidentification/models/intermediate_model_retrieval_chexpert.pth'
