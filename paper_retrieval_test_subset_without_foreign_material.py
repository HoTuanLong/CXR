...
def main():
    ...
    parser = argparse.ArgumentParser('Patient Retrieval Test Without Foreign Material')
    ...
    csv_clean_data = config["csv_clean_data"]
    ...
    # initialize Network
    test_set = eval_Dataset(image_root, csv_clean_data, size=[1024, 1024])

    #  load the new state dict
    model50.test_various_metrics(test_set, config["clean_data_save_path"])
